...
func GenMarkdownCustom(cmd *cobra.Command, w io.Writer, manuallyAddedContent map[int]string) error {
	...
	if hasSeeAlso(cmd) {
		...
		buf.WriteString("Go back to [command reference index]({{< ref \"reference/mesheryctl/_index.md\" >}}), if you want to add content manually to the CLI documentation, please refer to the [instruction]({{< ref \"project/contributing/contributing-cli/index.md#preserving-manually-added-documentation\" >}}) for guidance.")
		buf.WriteString("\n")
	}
...
func isGeneratedShortcode(shortcodeContent string) bool {
	return shortcodeContent == `ref "reference/mesheryctl/_index.md"` ||
